...
### Database Tables
`teams`, `matches`, `seasons`, `age_groups`, `divisions`, `match_types`, `team_match_types`, `user_profiles`, `match_of_the_week`, `division_age_groups`

### API Routes
`/api/auth/*`, `/api/standings`, `/api/matches`, `/api/match-types`, `/api/teams`, `/api/motw`, `/api/admin/*` (incl. `/api/admin/coverage`)
