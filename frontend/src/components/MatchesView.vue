      ...
      <div v-else>
        ...
        <div class="mb-6">
          ...
          <div :class="['space-y-4', showFilters || 'hidden lg:block']">
            ...
            <!-- Age Group Filter -->
            <div>
              <h3 class="text-sm font-medium text-fg mb-2">Age Groups</h3>
              <div
            ...
            <!-- Season Dropdown -->
            <div>
              <h3 class="text-sm font-medium text-fg mb-2">Season</h3>
              <select
            ...
            <div v-if="selectedViewTab === 'all'">
              ...
              <div class="grid grid-cols-3 gap-2">
                <button
                  ...
                  class="px-4 py-3 text-sm rounded-lg font-medium transition-colors min-h-[44px] bg-surface-alt text-fg active:bg-line hover:bg-line"
                >
                  ← Previous
                </button>
                <button
                  ...
                  :class="[
                    ...
                    weekOffset === 0
                      ? 'bg-brand-600 text-white'
                      : 'bg-surface-alt text-fg active:bg-line hover:bg-line',
                  ]"
                >
                  This Week
                </button>
        ...
        <div v-if="sortedGames.length > 0">
          ...
          >
            <div class="p-4 bg-surface-alt rounded-lg border border-line">
              <h4 class="font-medium text-fg mb-3">Season Summary</h4>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              ...
              >
                ...
                <div class="grid grid-cols-3 gap-2 text-sm">
                  ...
                  <div class="col-span-3 text-xs text-fg-muted mt-1">
                    Aug - Dec matches
                  </div>
                </div>
              </div>
          ...
          <!-- Desktop: Table View -->
          <table class="hidden lg:table w-full border border-line">
            <thead>
              <tr>
                <th
          ...
          <!--
            Mobile: compact list (SB-1101).

            Four near-identical blocks of card markup used to live here, one per
            league section plus My Club, and they had already drifted: My Club's
            actions were text links where the others were full-width buttons.
            MatchMobileList is that markup once.
          -->
          <div class="lg:hidden">
            <template v-if="selectedViewTab === 'all'">
              <MatchMobileList
              ...
              <MatchMobileList
                ...
                section-label="OTHER MATCHES"
                section-class="bg-gray-600 dark:bg-slate-700"
                :can-edit="canEditGame"
                :is-admin="authStore.isAdmin.value"
                @view="viewMatch"
                @edit="editMatch"
            ...
            <!-- My Club: one team, so the league band would say the same thing
                 on every group. The viewer's own team is marked instead. -->
            <MatchMobileList
              v-else
              :matches="sortedGames"
              :highlight-team-id="selectedTeam"
              :can-edit="canEditGame"
              :is-admin="authStore.isAdmin.value"
              @view="viewMatch"
              @edit="editMatch"
      ...
      if (selectedViewTab.value === 'all') {
        ...
        if (
          ...
          if (match.away_score > match.home_score) {
            ...
            // Draw
            return `${match.away_team_name} <span class="text-fg-muted">=</span> @ ${match.home_team_name} <span class="text-fg-muted">=</span>`;
          }
        }
      ...
      if (selectedViewTab.value === 'all') {
        ...
        if (
          ...
          if (match.away_score > match.home_score) {
            ...
            away.icon = '=';
            away.iconClass = 'text-fg-muted';
            home.icon = '=';
            home.iconClass = 'text-fg-muted';
          }
        }
