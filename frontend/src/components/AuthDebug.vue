<template>
  <div class="auth-debug">
    ...
    <div class="debug-info">
      ...
      <p>
        <strong>User:</strong> {{ authStore.state.user ? 'Present' : 'None' }}
      </p>
      <p>
        <strong>Session:</strong>
        {{ authStore.state.session ? 'Present' : 'None' }}
      </p>
      <p>
        <strong>Profile:</strong>
        {{ authStore.state.profile ? 'Present' : 'None' }}
      </p>
    ...
    <div class="debug-actions">
      ...
      <button @click="authStore.initialize()" class="debug-btn">
        Reinitialize Auth
      </button>
    </div>
  </div>
