...
Usage:
    ...
    python scripts/utilities/search_matches.py
    # Or from backend directory:
    uv run python scripts/utilities/search_matches.py

    # Search by team
    python scripts/utilities/search_matches.py --team IFA

    # Search by MLS ID (external match identifier)
    python scripts/utilities/search_matches.py --mls-id 100502

    # Search by age group and division
    python scripts/utilities/search_matches.py --age-group U14 --division "Elite Division"

    # Search by league
    python scripts/utilities/search_matches.py --league Academy

    # Search specific match type
    python scripts/utilities/search_matches.py --match-type Friendly

    # Search different season
    python scripts/utilities/search_matches.py --season 2024-2025

    # Combine filters
    python scripts/utilities/search_matches.py --team IFA --age-group U14 --season 2025-2026
"""
...
def search(
    ...
    Examples:
        ...
        # Search different season
        python scripts/utilities/search_matches.py --season 2024-2025 --match-type Tournament
    """
