...
class TestBuildScheduledKickoff:
    def test_combines_date_and_time(self, task):
        data = {"match_date": "2026-03-01", "match_time": "14:00"}
        assert task._build_scheduled_kickoff(data) == "2026-03-01T14:00:00"
...
class TestCheckNeedsUpdate:
    ...
    def test_kickoff_changed_returns_true(self, task):
        ...
        existing = {"match_status": "scheduled", "home_score": None, "away_score": None, "scheduled_kickoff": "2026-03-01T14:00:00"}
...
class TestUpdateMatchScores:
    ...
    def test_includes_scores_and_kickoff(self, task):
        ...
        new_data = {"home_score": 2, "away_score": 1, "match_status": "completed", "match_date": "2026-03-01", "match_time": "14:00"}
