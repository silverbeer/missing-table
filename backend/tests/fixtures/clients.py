...
def create_admin_client(user_id: str = "test-admin-001", email: str = "admin@test.com") -> TestClient:
    """
    ...
    """
    return create_authenticated_client(user_id=user_id, email=email, role="admin")


def create_team_manager_client(user_id: str = "test-manager-001", email: str = "manager@test.com") -> TestClient:
    """
    ...
    """
    return create_authenticated_client(user_id=user_id, email=email, role="team_manager")


def add_auth_headers(
    client: TestClient, token: str | None = None, user_id: str = "test-user", role: str = "user"
) -> TestClient:
    """
...
if __name__ == "__main__":
    ...
    user_client = create_authenticated_client(user_id="test-user-123", email="testuser@example.com", role="user")
    ...
    custom_client = create_client_with_headers({"X-Custom-Header": "test-value", "User-Agent": "test-agent"})
