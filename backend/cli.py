...
@app.command()
def add_game(
    date: Optional[str] = typer.Option(None, "--date", "-d", help="Game date (YYYY-MM-DD)"),
    home_team: Optional[str] = typer.Option(None, "--home", "-h", help="Home team name"),
    away_team: Optional[str] = typer.Option(None, "--away", "-a", help="Away team name"),
    home_score: Optional[int] = typer.Option(None, "--home-score", "-hs", help="Home team score"),
    away_score: Optional[int] = typer.Option(None, "--away-score", "-as", help="Away team score"),
):
...
@app.command()
def recent_games(
    limit: int = typer.Option(10, "--limit", "-l", help="Number of games to show")
):
    """Show recent games."""
    try:
