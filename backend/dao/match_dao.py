...
class MatchDAO:
    ...
    # Team methods have been moved to TeamDAO - see dao/team_dao.py
    ...
    # Team methods (update_team, delete_team, create_team_mapping, delete_team_mapping,
    # get_team_game_counts) have been moved to TeamDAO - see dao/team_dao.py
    # get_all_parent_club_entities has been moved to ClubDAO - see dao/club_dao.py
    # User profile and player methods have been moved to PlayerDAO - see dao/player_dao.py
