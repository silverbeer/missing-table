...
class SportsDAO:
    ...
    def add_game(
        self, game_date: str, home_team: str, away_team: str, home_score: int, away_score: int
    ) -> bool:
    ...
    def get_game_by_date_and_teams(self, game_date: str, home_team: str, away_team: str) -> bool:
        ...
        try:
            ...
            print(f"Error occurred while fetching game: {e!s}")
            return False
    ...
    def update_game(
        ...
        try:
            ...
            print(f"Error occurred while updating game with ID {game_id}: {e!s}")
            return False
...
if __name__ == "__main__":
    ...
    try:
        ...
        for game in games[:3]:  # Show first 3 games
            print(
                f"  - {game['game_date']}: {game['home_team']} vs {game['away_team']} ({game['home_score']}-{game['away_score']})"
            )
