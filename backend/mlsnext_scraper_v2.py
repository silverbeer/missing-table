...
class MLSNextScraperV2:
    ...
    async def scrape_games(self, match_date: str = None, club: str = None, division: str = "Northeast"):
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                if division:
                    print(f"🏆 Looking for division dropdown...")
                    ...
                    for select_elem in selects:
                        try:
                            ...
                            options = await select_elem.evaluate("el => Array.from(el.options).map(opt => opt.text)")
                ...
                if club:
                    ...
                    club_dropdown = page.locator('div:has-text("Club") + div select, select').nth(1)  # Usually the 2nd dropdown
    ...
    async def _ensure_u13_selected(self, page):
        ...
        try:
            ...
            for select in age_group_selects:
                try:
                    options = await select.evaluate("el => Array.from(el.options).map(opt => opt.text)")
    ...
    async def _select_september_2024_range(self, page):
        ...
        try:
            ...
            try:
                ...
                main_frame = page.get_by_role('main', name='Page main content').locator('iframe').content_frame
                ...
                if count > 0:
                    ...
                    for i in range(count):
                        ...
                        if game_data:
                            ...
                            print(f"   📝 Game: {game_data['home_team']} vs {game_data['away_team']} ({game_data['home_score']}-{game_data['away_score']})")
    ...
    def save_to_csv(self, filename: str = None):
        ...
        with open(filename, 'w', newline='', encoding='utf-8') as csvfile:
            fieldnames = ['game_date', 'home_team', 'away_team', 'home_score', 'away_score', 'time', 'field']
